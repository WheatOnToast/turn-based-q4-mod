...
//q4_mod_selectedUnit_functions
const idEntity* selectedUnit;

void setSelectedUnit(const idEntity* a) {
	selectedUnit = a;
}

const idEntity* getSelectedUnit() {
	gameLocal.Printf("Selected Unit: %f\n", selectedUnit);
	return selectedUnit;
}
